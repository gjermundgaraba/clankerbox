...
poll operation state. Label edits are synchronous, and session calls never create
lifecycle Operations. There is no event feed or change stream. Waits never resubmit a mutation, and an
