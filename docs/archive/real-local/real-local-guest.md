> Historical qualification evidence. The duplicate guest daemon is retired; product daemon tests and protocol/test/guest-qualification.mjs now own these checks.
